        ...
        <div class="main-container page-header__container page-header__container--index">
            ...
            <div class="header__account--index">
                <a href="#" class="header__account-enter open-modal" data-for="enter-form">
                    <span>Вход</span></a>
                или
                <a href="{{route('auth.register')}}" class="header__account-registration">
                    Регистрация
                </a>
            </div>
        </div>
        ...
        <div class="main-container page-footer__container">
            <div class="page-footer__info">
                <p class="page-footer__info-copyright">
                    © {{\Illuminate\Support\Carbon::now()->year}}, ООО «ТаскФорс»
                    Все права защищены
                </p>
            ...
            <div class="page-footer__copyright">
                <a href="https://htmlacademy.ru">
                    <img class="copyright-logo"
                         src="{{asset('assets/img/academy-logo.png')}}"
                         width="185" height="63"
    ...
    <section class="modal enter-form form-modal" id="enter-form">
        ...
        <form action="{{route('auth.login')}}" method="post" id="login-form">
            ...
            <p>
                ...
                <input class="form-control enter-form-email input input-middle" type="email" name="email"
                       id="enter-email">
            @error('email')
            ...
            <p>
                ...
                <input class="enter-form-email input input-middle" type="password" name="password"
                       id="enter-password">
                            @error('password')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
